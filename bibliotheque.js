exports.game = {
    "base": {
        ...
        "structure" : {
            1 : "Célibataire",
            2 : "Couple",
            3 : "Un parent différent par enfant, en couple",
            4 : "Un parent différent par enfant, célibataire",
            5 : "Célibataire avec aide(services)",
            6 : "Couple avec aide(services)"
        },
        "nombreEnfants" : {
            1 : "Un",
            2 : "Deux",
        ...
        "revenus" : {
            ...
            3 : "Carrière à mi-temps (choix libre)"
        },
        "carrieresConventionnelles" : {
            ...
            9 : "Athlète",
            10 : "Affaires",
            11 : "Influenceur de style",
            12 : "Auteur",
            13 : "Auteur numérique (carrière disponible sur téléphone)",
            14: "Programmeur (carrière disponible sur téléphone)",
            15 : "Créateur (carrière disponible sur téléphone)",
            16: "Peintre Electrisé"
        },
        "carrieresNonConventionnelles" : {
            1 : "Peintre indépendant",
            2 : "Musicien",
            4 : "Joueur Professionnel",
            5 : "Cybercriminel",
            6 : "Hôte professionnel",
            7 : "Gagnant de concours",
            8 : "Photographe (carrière disponible sur téléphone)",
            9 : "Auteur indépendant (sans la carrière disponible sur le téléphone)",
            10 : "Programmeur indépendant (sans la carrière disponible sur le téléphone)",
            11 : "Créateur",
            12 : "Fabricant indépendant (carrière disponible sur téléphone)",
            13 : "Chasseur de Trésors"
        },
        "carrieresMiTemps" : {
            1 : "Baby-sitter",
            2 : "Barista",
            3 : "Employé de fast-food",
            4 : "Employé de commerce",
            5 : "Ouvrier"
        },
        ...
        "heritier" : {
            ...
            3 : "Patriarcat - L'ainé des garçons",
    ...
    "Les Sims 4 - A la Fac" : {
        ...
        "carrieresMiTemps" : {
            1 : "Joueur de l'équipe de football",
            2 : "Joueur d'E-Sport"
        }
    },
